...
type DecisionTable struct {
	...
	InputsColumns   []TableInput    `json:"input_columns" gorm:"type:jsonb" bson:"input_columns"`
	OutputsColumns  []TableOutput   `json:"output_columns" gorm:"type:jsonb" bson:"output_columns"`
