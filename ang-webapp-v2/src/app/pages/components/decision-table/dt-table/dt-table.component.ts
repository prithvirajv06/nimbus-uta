...
export class DtTableComponent extends BasicTableComponent<DecisionTable> implements OnInit {
  ...
  hitPolicyOptions: Option[] = [
    { value: "FIRST", label: "FIRST" },
    { value: "ALL", label: "ALL" },
    { value: "RULE ORDER", label: "RULE ORDER" },
    { value: "OUTPUT ORDER", label: "OUTPUT ORDER" },
  ...
  onSubmit() {
    if (this.formGroup().valid()) {
      ...
      this.service.create(newDT).subscribe({
        next: (res: ApiResponse<DecisionTable>) => {
